...
Important notes:
PNG alternatives are rendered by PHP's imagemagick extension. You can check if this is available by consulting your php.ini file or simple writing a small PHP file with just phpinfo() (which will output all PHP configuration settings) and search for the word "ImageMagick". 
